...
const HeroSection = () => {
  ...
  return (
    <section className="bg-linear-to-br from-blue-600 via-blue-700 to-teal-600 text-white overflow-hidden">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              <Button
                asChild
                size="lg"
                className="bg-white text-blue-700 hover:bg-blue-50 font-semibold rounded-xl gap-2 shadow-md"
              >
                <Link href="/booking">
          ...
          <div className="hidden md:block">
            <div className="relative">
              ...
              <Card className="absolute -bottom-4 -left-4 shadow-xl border-0">
